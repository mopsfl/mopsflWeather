    ...
    (function() {
      ...
      var Un = { "\\": "\\", "'": "'", "\n": "n", "\r": "r", "\u2028": "u2028", "\u2029": "u2029" }, Cn = parseFloat, Dn = parseInt, Mn = typeof global == "object" && global && global.Object === Object && global, Tn = typeof self == "object" && self && self.Object === Object && self, $n = Mn || Tn || Function("return this")(), Fn = typeof exports == "object" && exports && !exports.nodeType && exports, Nn = Fn && typeof module == "object" && module && !module.nodeType && module, Pn = Nn && Nn.exports === Fn, Zn = Pn && Mn.process, qn = function() {
        ...
        function yt(n2, t2, r2, e2) {
          ...
          n:
            for (; ++u2 < l2; ) {
              var p2 = n2[u2], _4 = null == r2 ? p2 : r2(p2), p2 = e2 || 0 !== p2 ? p2 : 0;
              if (a2 && _4 === _4) {
                for (var v2 = h2; v2--; )
                  if (t2[v2] === _4)
                    continue n;
        ...
        function Wt(n2, t2, r2) {
          ...
          var p2 = n2[0], _4 = -1, v2 = l2[0];
          n:
            for (; ++_4 < u2 && h2.length < s2; ) {
              var g2 = p2[_4], d2 = t2 ? t2(g2) : g2, g2 = r2 || 0 !== g2 ? g2 : 0;
                    ...
                    if (u2 || (u2 = new Zn2()), i2 = 1 & r2, f2 = _e(n2), o2 = f2.length, c2 = _e(t2).length, o2 == c2 || i2) {
                      ...
                      if ((c2 = u2.get(n2)) && u2.get(t2))
                        ...
                        for (var s2 = i2; ++a2 < o2; ) {
                          ...
                          if (e2)
                            var _4 = i2 ? e2(p2, h2, l2, t2, n2, u2) : e2(h2, p2, l2, n2, t2, u2);
                          if (_4 === T ? h2 !== p2 && !Mt(h2, p2, r2, e2, u2) : !_4) {
                            c2 = false;
                            break;
                          }
          ...
          n2 !== t2 && oo(t2, function(i2, o2) {
            if (u2 || (u2 = new Zn2()), du(i2)) {
              ...
              if (l2)
                ...
                if (s2) {
                  var h2 = ff(a2), p2 = !h2 && af(a2), _4 = !h2 && !p2 && _f(a2), l2 = a2;
                  h2 || p2 || _4 ? ff(c2) ? l2 = c2 : hu(c2) ? l2 = Ur(c2) : p2 ? (s2 = false, l2 = Ir(a2, true)) : _4 ? (s2 = false, l2 = zr(a2, true)) : l2 = [] : xu(a2) || of(a2) ? (l2 = c2, of(c2) ? l2 = Ou(c2) : du(c2) && !_u(c2) || (l2 = Ae(a2))) : s2 = false;
                }
        ...
        function vr(n2, t2, r2, e2) {
          ...
          for (var u2 = 0, i2 = null == n2 ? 0 : n2.length, o2 = t2 !== t2, f2 = null === t2, c2 = wu(t2), a2 = t2 === T; u2 < i2; ) {
            var l2 = Ii((u2 + i2) / 2), s2 = r2(n2[l2]), h2 = s2 !== T, p2 = null === s2, _4 = s2 === s2, v2 = wu(s2);
            (o2 ? e2 || _4 : a2 ? _4 && (e2 || h2) : f2 ? _4 && h2 && (e2 || !p2) : c2 ? _4 && h2 && !p2 && (e2 || !v2) : p2 || v2 ? 0 : e2 ? s2 <= t2 : s2 < t2) ? u2 = l2 + 1 : i2 = l2;
          }
        ...
        function Jr(n2, t2, r2, e2, u2, i2, o2, f2, c2, a2) {
          function l2() {
            ...
            if (e2 && (y2 = Br(y2, e2, u2, _4)), i2 && (y2 = Lr(y2, i2, o2, _4)), d2 -= x3, _4 && d2 < a2)
          ...
          var s2 = 128 & t2, h2 = 1 & t2, p2 = 2 & t2, _4 = 24 & t2, v2 = 512 & t2, g2 = p2 ? T : Vr(n2);
          return l2;
        }
        function Yr(n2, t2) {
          return function(r2, e2) {
        ...
        function se(n2, t2, r2, e2, u2, i2) {
          ...
          for (i2.set(n2, t2), i2.set(t2, n2); ++c2 < f2; ) {
            ...
            if (e2)
              var _4 = o2 ? e2(p2, s2, c2, t2, n2, i2) : e2(s2, p2, c2, n2, t2, i2);
            if (_4 !== T) {
              if (_4)
                continue;
              a2 = false;
        ...
        function Ne(n2, t2, r2) {
          ...
          return e2 ? (r2 = null == r2 ? 0 : Eu(r2), 0 > r2 && (r2 = Ui(e2 + r2, 0)), _3(n2, ye(t2, 3), r2)) : -1;
        }
        function Pe(n2, t2, r2) {
          ...
          if (!e2)
            return -1;
          var u2 = e2 - 1;
          return r2 !== T && (u2 = Eu(r2), u2 = 0 > r2 ? Ui(e2 + u2, 0) : Ci(u2, e2 - 1)), _3(n2, ye(t2, 3), u2, true);
        }
        function Ze(n2) {
        ...
        function fu(n2, t2, r2) {
          function e2(t3) {
            var r3 = c2, e3 = a2;
            return c2 = a2 = T, _4 = t3, s2 = n2.apply(e3, r3);
          }
          function u2(n3) {
            var r3 = n3 - p2;
            return n3 -= _4, p2 === T || r3 >= t2 || 0 > r3 || g2 && n3 >= l2;
          }
          function i2() {
            var n3 = Go();
            if (u2(n3))
              return o2(n3);
            var r3, e3 = bo;
            r3 = n3 - _4, n3 = t2 - (n3 - p2), r3 = g2 ? Ci(n3, l2 - r3) : n3, h2 = e3(i2, r3);
          }
          function o2(n3) {
          ...
          function f2() {
            ...
            if (c2 = arguments, a2 = this, p2 = n3, r3) {
              if (h2 === T)
                return _4 = n3 = p2, h2 = bo(i2, t2), v2 ? e2(n3) : s2;
              if (g2)
                return lo(h2), h2 = bo(i2, t2), e2(p2);
            }
            return h2 === T && (h2 = bo(i2, t2)), s2;
          }
          var c2, a2, l2, s2, h2, p2, _4 = 0, v2 = false, g2 = false, d2 = true;
          if (typeof n2 != "function")
            throw new ti("Expected a function");
...
var weather_data_citytemperature = document.querySelector(".weather_data_citytemperature");
var weather_data_cityskydesc = document.querySelector(".weather_data_cityskydesc");
var weather_data_citywinddata = document.querySelector(".weather_data_citywinddata");
var WeatherApi = class {
   ...
   * @returns 
   */
  async GetDefaultWeatherData(secureProtocol = HTTPS_SERVER, dev = DEV_MODE) {
  ...
  async GetWeatherData(args, secureProtocol = HTTPS_SERVER, dev = DEV_MODE) {
    ...
    if (args.name && !(args.lat || args.lon)) {
      ...
      weather_data_citywinddata.innerHTML = `<br>Wind: ${wind.speed} km/h<br>B\xF6hen: ${wind.gust} km/h`;
      console.log(data);
    }
    loadingCircle.ToggleLoading(false, weather_data_cityname_loading);
    weather_data_cityname.classList.remove("hide");
...
// index.ts
var _2 = __toESM(require_lodash_min());
var DEV_MODE = false;
...
window.modules = {
  ...
  initialized: { weatherApi: weatherApi2, weatherIcon, localStorage: localStorage2, loadingCircle: loadingCircle2, searchCity, geoLocation, lodash: _2 }
};
...
await navigator.permissions.query({ name: "geolocation" }).then(async (res) => {
  ...
  if (window.geolocation_state == "denied")
    console.warn(new Error(`geolocation_state: ${window.geolocation_state}`));
