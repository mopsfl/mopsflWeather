...
var _dropdownItemTemplate = $(".dropdown-item-template");
var _autocompleteDropdown = $(".autocomplete-dropdown");
var _searchBoxLoadingSpinner = $(".search-box-loading-spinner");
var SearchCity_default = {
  InitInput(inputElement) {
    ...
    inputElement.on("propertychange input", () => {
      ...
      _typingTimer = setTimeout(async () => await SearchCity_default.HandleSearchInput(inputElement.val(), inputElement), doneTypingInterval);
    });
