    ...
    TimeUntil(timestamp, timezone = 0, toUnix) {
        ...
        if (difference > 0) {
            if (hours > 0) {
                ...
                return Strings_1.default.ToString(__1.languageStrings.WEATHER_INFO_TIMEIN_MINUTES, minutes);
            }
            else {
                return Strings_1.default.ToString(__1.languageStrings.WEATHER_INFO_TIMEIN_SECONDS, seconds);
            }
        }
        else if (difference < 0) {
            if (hours > 0) {
                return Strings_1.default.ToString(__1.languageStrings.WEATHER_INFO_TIMEAGO_HOURS, hours);
            }
            else if (minutes > 0) {
                return Strings_1.default.ToString(__1.languageStrings.WEATHER_INFO_TIMEAGO_MINUTES, minutes);
            }
            else {
