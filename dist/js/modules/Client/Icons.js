...
exports.default = {
    GetIcon(name, timezone, isDay) {
        const settings = Global_1.App.settings.GetSettings(), hours = new Date(new Date().getTime() + (timezone !== undefined ? timezone : 0) * 1000).getUTCHours(), isDayTime = isDay !== undefined ? isDay : (hours > 6 && hours < 20);
