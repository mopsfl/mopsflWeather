...
exports.default = {
    ...
    ConvertIsoToReadableTime(isoTime) {
    ...
    TimeUntil(timestamp, timezone = 0, toUnix) {
        ...
        if (difference > 0) {
            if (hours > 0) {
                return Strings_1.default.ToString(Strings_1.default.Languages[Global_1.App.client.language].WEATHER_INFO_TIMEIN_HOURS, hours);
            }
            else if (minutes > 0) {
                return Strings_1.default.ToString(Strings_1.default.Languages[Global_1.App.client.language].WEATHER_INFO_TIMEIN_MINUTES, minutes);
            }
            else {
                return Strings_1.default.ToString(Strings_1.default.Languages[Global_1.App.client.language].WEATHER_INFO_TIMEIN_SECONDS, seconds);
            }
        }
        else if (difference < 0) {
            if (hours > 0) {
                return Strings_1.default.ToString(Strings_1.default.Languages[Global_1.App.client.language].WEATHER_INFO_TIMEAGO_HOURS, hours);
            }
            else if (minutes > 0) {
                return Strings_1.default.ToString(Strings_1.default.Languages[Global_1.App.client.language].WEATHER_INFO_TIMEAGO_MINUTES, minutes);
            }
            else {
                return Strings_1.default.ToString(Strings_1.default.Languages[Global_1.App.client.language].WEATHER_INFO_TIMEAGO_SECONDS, seconds);
            }
        }
    },
};
